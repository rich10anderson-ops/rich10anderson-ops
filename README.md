...
- **L’ESTETIQUE 2026** → Plataforma digital de estética moderna.  
- **pim‑4** → CRUD robusto en Firestore desplegado en Vercel.  
- **EcommerceStreet** → E‑commerce con arquitectura modular y optimización de rendimiento.
